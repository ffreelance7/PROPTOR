export function captureUserCamera(callback) {
  ...
  export function captureUserWindow(callback) {
    ...
    navigator.mediaDevices.getDisplayMedia(displayMediaOptions,callback,(error)=>{
      alert(JSON.stringify(error));
    });  
  };
